...
export function ProjectCard({
  ...
  return (
    <Link
      ...
      className="group grid grid-cols-1 gap-x-8 gap-y-4 border-t border-border py-10 transition-colors duration-200 first:border-t-0 sm:grid-cols-[3rem_1fr] lg:grid-cols-[3rem_1fr_11rem]"
    >
